...
function custom_admin_default_page() {
  ...
  // http://www.example.com/custom-user-dashboard.
	...
	if ( $GLOBALS['url'] == "http://luganskaid.org/wp-login.php?redirect_to=http%3A%2F%2Fluganskaid.org%2Fdonation-form%2F" ) {
		return home_url('/donation-form/');
	} elseif ( $GLOBALS['url'] == "http://luganskaid.org/wp-login.php" ) {
		return home_url('');
	}
}
