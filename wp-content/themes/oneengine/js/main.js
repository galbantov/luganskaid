...
jQuery(document).ready(function($) {
	...
	// SCROLL TO
	$('#main-menu-top a,ul.slicknav_nav li a').click(function(event){if( this.hash.indexOf("#") < 0 ) return true;event.stopPropagation(); event.preventDefault();
	...
	$('.close-port').click(function(){
		$.scrollTo(".portfolio-wrapper", 200, {easing:'easeOutExpo',onAfter:function(){
			$('#portfolio_content').fadeOut(200);
		}});
	});
	...
	function setColumns() { 
		...
		container.find('.item.isotope-item h5').each(function () { 
			$(this).css( { 
