...
switch ( $donation->post_status ) :
	...
	case 'pending_payment' :
		echo '<script>$(document).ready(function(){window.location.href = "http://luganskaid.org/thank-you";});</script>';
		print( __( '<script>$(document).ready(function(){window.location.href = "http://luganskaid.org/thank-you";});</script><h2 style="text-align: center;">Donation submitted successfully. Your donation will be taken into account as soon as we receive the payment gateway validation (it can take several minutes).</h2>', 'wpdonations' ) );
	break;
