...
<head>
	...
	<link rel="apple-touch-icon" sizes="114x114" href="<?php echo oneengine_option('touch_icon_144', false, 'url'); ?>"><link href="../wp-content/themes/oneengine/css/jquery-ui.css" rel="stylesheet">
    <!-- Favicons / End -->
	
	<!-- JavaScript
	================================================== -->
	<script src="../wp-content/themes/oneengine/js/jquery.js"></script>
	<script src="../wp-content/themes/oneengine/js/jquery-ui.js"></script>
	<script src="../wp-content/themes/oneengine/js/custom.js"></script>
