...
class WPdonations_Shortcodes {
	...
	public function __construct() {
		...
		add_shortcode( 'the_donors', 	array( $this, 'output_donors' ) );
	}
	...
	/**
	 * The Donors list shortcode
	 *
	 * @access public
	 * @param array $args
	 * @return string
	 */
	public function output_donors( $atts ) {
		global $wpdonations;
		...
		return the_donors( $before, $after, false, $order );
	}
}
